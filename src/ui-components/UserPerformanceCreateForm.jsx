...
import { createUserPerformance } from "../graphql/mutations";
...
export default function UserPerformanceCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setAccountValue(initialValues.accountValue);
    setCash(initialValues.cash);
    setTodayChange(initialValues.todayChange);
    setAnnualReturn(initialValues.annualReturn);
    setPerformance(initialValues.performance);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createUserPerformance.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "UserPerformanceCreateForm")}
      {...rest}
    >
      <TextField
        label="Account value"
